...
#[doc = "Field `CACHEINVALID` reader - desc CACHEINVALID"]
pub type CacheinvalidR = crate::BitReader;
#[doc = "Field `CACHEINVALID` writer - desc CACHEINVALID"]
pub type CacheinvalidW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 5 - desc CACHEINVALID"]
    #[inline(always)]
    pub fn cacheinvalid(&self) -> CacheinvalidR {
        CacheinvalidR::new(((self.bits >> 5) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:2 - desc WAIT"]
    ...
    #[doc = "Bit 5 - desc CACHEINVALID"]
    #[inline(always)]
    pub fn cacheinvalid(&mut self) -> CacheinvalidW<'_, Cr2Spec> {
        CacheinvalidW::new(self, 5)
    }
