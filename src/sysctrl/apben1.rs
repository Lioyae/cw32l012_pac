...
impl W {
    ...
    #[doc = "Bit 7 - desc GTIM2"]
    #[inline(always)]
    pub fn gtim2(&mut self) -> Gtim2W<'_, Apben1Spec> {
        Gtim2W::new(self, 7)
    }
    #[doc = "Bit 8 - desc UART3"]
    #[inline(always)]
    pub fn uart3(&mut self) -> Uart3W<'_, Apben1Spec> {
        Uart3W::new(self, 8)
    }
    #[doc = "Bit 11 - desc GTIM3"]
    #[inline(always)]
    pub fn gtim3(&mut self) -> Gtim3W<'_, Apben1Spec> {
        Gtim3W::new(self, 11)
    }
    #[doc = "Bit 12 - desc GTIM4"]
    #[inline(always)]
    pub fn gtim4(&mut self) -> Gtim4W<'_, Apben1Spec> {
        Gtim4W::new(self, 12)
    }
    #[doc = "Bit 13 - desc SPI2"]
    #[inline(always)]
    pub fn spi2(&mut self) -> Spi2W<'_, Apben1Spec> {
        Spi2W::new(self, 13)
    }
    #[doc = "Bit 14 - desc SPI3"]
    #[inline(always)]
    pub fn spi3(&mut self) -> Spi3W<'_, Apben1Spec> {
        Spi3W::new(self, 14)
    }
