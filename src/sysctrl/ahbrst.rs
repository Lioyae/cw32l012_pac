...
#[doc = "Field `EAU` reader - desc EAU"]
pub type EauR = crate::BitReader;
#[doc = "Field `EAU` writer - desc EAU"]
pub type EauW<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `CORDIC` reader - desc CORDIC"]
pub type CordicR = crate::BitReader;
#[doc = "Field `CORDIC` writer - desc CORDIC"]
pub type CordicW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - desc DMA"]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - desc EAU"]
    #[inline(always)]
    pub fn eau(&self) -> EauR {
        EauR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[doc = "Bit 7 - desc GPIOF"]
    #[inline(always)]
    pub fn gpiof(&self) -> GpiofR {
        GpiofR::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - desc CORDIC"]
    #[inline(always)]
    pub fn cordic(&self) -> CordicR {
        CordicR::new(((self.bits >> 8) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - desc DMA"]
    #[inline(always)]
    pub fn dma(&mut self) -> DmaW<'_, AhbrstSpec> {
        DmaW::new(self, 0)
    }
    #[doc = "Bit 1 - desc FLASH"]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - desc EAU"]
    #[inline(always)]
    pub fn eau(&mut self) -> EauW<'_, AhbrstSpec> {
        EauW::new(self, 3)
    }
    #[doc = "Bit 4 - desc GPIOA"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - desc GPIOC"]
    #[inline(always)]
    pub fn gpioc(&mut self) -> GpiocW<'_, AhbrstSpec> {
        GpiocW::new(self, 6)
    }
    #[doc = "Bit 7 - desc GPIOF"]
    #[inline(always)]
    pub fn gpiof(&mut self) -> GpiofW<'_, AhbrstSpec> {
        GpiofW::new(self, 7)
    }
    #[doc = "Bit 8 - desc CORDIC"]
    #[inline(always)]
    pub fn cordic(&mut self) -> CordicW<'_, AhbrstSpec> {
        CordicW::new(self, 8)
    }
}
