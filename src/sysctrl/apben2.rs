...
impl W {
    ...
    #[doc = "Bit 5 - desc WWDT"]
    #[inline(always)]
    pub fn wwdt(&mut self) -> WwdtW<'_, Apben2Spec> {
        WwdtW::new(self, 5)
    }
    #[doc = "Bit 6 - desc I2C1"]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - desc OPA"]
    #[inline(always)]
    pub fn opa(&mut self) -> OpaW<'_, Apben2Spec> {
        OpaW::new(self, 9)
    }
    #[doc = "Bit 10 - desc DAC"]
    #[inline(always)]
    pub fn dac(&mut self) -> DacW<'_, Apben2Spec> {
        DacW::new(self, 10)
    }
    #[doc = "Bit 11 - desc I2C2"]
    #[inline(always)]
    pub fn i2c2(&mut self) -> I2c2W<'_, Apben2Spec> {
        I2c2W::new(self, 11)
    }
    #[doc = "Bit 12 - desc HALLTIM"]
    #[inline(always)]
    pub fn halltim(&mut self) -> HalltimW<'_, Apben2Spec> {
