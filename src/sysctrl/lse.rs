...
#[doc = "Field `PINLOCK` reader - desc PINLOCK"]
pub type PinlockR = crate::BitReader;
#[doc = "Field `PINLOCK` writer - desc PINLOCK"]
pub type PinlockW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bits 8:11 - desc PDRIVER"]
    #[inline(always)]
    pub fn pdriver(&self) -> PdriverR {
        PdriverR::new(((self.bits >> 8) & 0x0f) as u8)
    }
    #[doc = "Bit 17 - desc PINLOCK"]
    #[inline(always)]
    pub fn pinlock(&self) -> PinlockR {
        PinlockR::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - desc STABLE"]
    #[inline(always)]
    pub fn stable(&self) -> StableR {
        StableR::new(((self.bits >> 18) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:3 - desc DRIVER"]
    ...
    #[doc = "Bits 8:11 - desc PDRIVER"]
    #[inline(always)]
    pub fn pdriver(&mut self) -> PdriverW<'_, LseSpec> {
        PdriverW::new(self, 8)
    }
    #[doc = "Bit 17 - desc PINLOCK"]
    #[inline(always)]
    pub fn pinlock(&mut self) -> PinlockW<'_, LseSpec> {
        PinlockW::new(self, 17)
    }
}
