...
#[doc = "Field `AWTPRS` reader - desc AWTPRS"]
pub type AwtprsR = crate::FieldReader;
#[doc = "Field `AWTPRS` writer - desc AWTPRS"]
pub type AwtprsW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `AWTSRC` reader - desc AWTSRC"]
pub type AwtsrcR = crate::BitReader;
#[doc = "Field `AWTSRC` writer - desc AWTSRC"]
pub type AwtsrcW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bits 0:1 - desc AWTPRS"]
    #[inline(always)]
    pub fn awtprs(&self) -> AwtprsR {
        AwtprsR::new((self.bits & 3) as u8)
    }
    #[doc = "Bit 2 - desc AWTSRC"]
    #[inline(always)]
    pub fn awtsrc(&self) -> AwtsrcR {
        AwtsrcR::new(((self.bits >> 2) & 1) != 0)
    }
...
impl W {
    #[doc = "Bits 0:1 - desc AWTPRS"]
    #[inline(always)]
    pub fn awtprs(&mut self) -> AwtprsW<'_, Cr2Spec> {
        AwtprsW::new(self, 0)
    }
    #[doc = "Bit 2 - desc AWTSRC"]
    #[inline(always)]
