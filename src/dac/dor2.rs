...
impl W {
    #[doc = "Bits 0:11 - desc DATA"]
    #[inline(always)]
    pub fn data(&mut self) -> DataW<'_, Dor2Spec> {
        DataW::new(self, 0)
    }
    #[doc = "Bit 15 - desc DMAUDR"]
    #[inline(always)]
    pub fn dmaudr(&mut self) -> DmaudrW<'_, Dor2Spec> {
        DmaudrW::new(self, 15)
    }
}
#[doc = "desc DOR2\n\nYou can [`read`](crate::Reg::read) this register and get [`dor2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dor2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Dor2Spec;
...
impl crate::Writable for Dor2Spec {
