...
#[doc = "Register `CCNT2` writer"]
pub type W = crate::W<Ccnt2Spec>;
...
impl W {
    #[doc = "Bits 0:15 - desc CCNT"]
    #[inline(always)]
    pub fn ccnt(&mut self) -> CcntW<'_, Ccnt2Spec> {
        CcntW::new(self, 0)
    }
    #[doc = "Bits 16:19 - desc CREPEAT"]
    #[inline(always)]
    pub fn crepeat(&mut self) -> CrepeatW<'_, Ccnt2Spec> {
        CrepeatW::new(self, 16)
    }
}
#[doc = "Channel1 trigger register\n\nYou can [`read`](crate::Reg::read) this register and get [`ccnt2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccnt2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`ccnt2::W`](W) writer structure"]
impl crate::Writable for Ccnt2Spec {
