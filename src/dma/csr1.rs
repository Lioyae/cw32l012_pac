...
impl W {
    #[doc = "Bit 0 - desc EN"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, Csr1Spec> {
        EnW::new(self, 0)
    }
    #[doc = "Bit 1 - desc TCIE"]
    #[inline(always)]
    pub fn tcie(&mut self) -> TcieW<'_, Csr1Spec> {
        TcieW::new(self, 1)
    }
    #[doc = "Bit 2 - desc TEIE"]
    #[inline(always)]
    pub fn teie(&mut self) -> TeieW<'_, Csr1Spec> {
        TeieW::new(self, 2)
    }
    #[doc = "Bit 3 - desc TRANS"]
    #[inline(always)]
    pub fn trans(&mut self) -> TransW<'_, Csr1Spec> {
        TransW::new(self, 3)
    }
    #[doc = "Bit 4 - desc SRCINC"]
    #[inline(always)]
    pub fn srcinc(&mut self) -> SrcincW<'_, Csr1Spec> {
        SrcincW::new(self, 4)
    }
    #[doc = "Bit 5 - desc DSTINC"]
    #[inline(always)]
    pub fn dstinc(&mut self) -> DstincW<'_, Csr1Spec> {
        DstincW::new(self, 5)
    }
    #[doc = "Bits 6:7 - desc SIZE"]
    #[inline(always)]
    pub fn size(&mut self) -> SizeW<'_, Csr1Spec> {
        SizeW::new(self, 6)
    }
    #[doc = "Bits 8:10 - desc STATUS"]
    #[inline(always)]
    pub fn status(&mut self) -> StatusW<'_, Csr1Spec> {
        StatusW::new(self, 8)
    }
    #[doc = "Bit 11 - desc RESTART"]
    #[inline(always)]
    pub fn restart(&mut self) -> RestartW<'_, Csr1Spec> {
        RestartW::new(self, 11)
    }
    #[doc = "Bit 14 - desc SRCLOAD"]
    #[inline(always)]
    pub fn srcload(&mut self) -> SrcloadW<'_, Csr1Spec> {
        SrcloadW::new(self, 14)
    }
    #[doc = "Bit 15 - desc DSTLOAD"]
    #[inline(always)]
    pub fn dstload(&mut self) -> DstloadW<'_, Csr1Spec> {
