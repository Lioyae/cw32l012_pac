...
impl W {
    #[doc = "Bit 0 - desc EN"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, Csr3Spec> {
        EnW::new(self, 0)
    }
    #[doc = "Bit 1 - desc TCIE"]
    #[inline(always)]
    pub fn tcie(&mut self) -> TcieW<'_, Csr3Spec> {
        TcieW::new(self, 1)
    }
    #[doc = "Bit 2 - desc TEIE"]
    #[inline(always)]
    pub fn teie(&mut self) -> TeieW<'_, Csr3Spec> {
        TeieW::new(self, 2)
    }
    #[doc = "Bit 3 - desc TRANS"]
    #[inline(always)]
    pub fn trans(&mut self) -> TransW<'_, Csr3Spec> {
        TransW::new(self, 3)
    }
    #[doc = "Bit 4 - desc SRCINC"]
    #[inline(always)]
    pub fn srcinc(&mut self) -> SrcincW<'_, Csr3Spec> {
        SrcincW::new(self, 4)
    }
    #[doc = "Bit 5 - desc DSTINC"]
    #[inline(always)]
    pub fn dstinc(&mut self) -> DstincW<'_, Csr3Spec> {
        DstincW::new(self, 5)
    }
    #[doc = "Bits 6:7 - desc SIZE"]
    #[inline(always)]
    pub fn size(&mut self) -> SizeW<'_, Csr3Spec> {
        SizeW::new(self, 6)
    }
    #[doc = "Bits 8:10 - desc STATUS"]
    #[inline(always)]
    pub fn status(&mut self) -> StatusW<'_, Csr3Spec> {
        StatusW::new(self, 8)
    }
    #[doc = "Bit 11 - desc RESTART"]
    #[inline(always)]
    pub fn restart(&mut self) -> RestartW<'_, Csr3Spec> {
        RestartW::new(self, 11)
    }
    #[doc = "Bit 14 - desc SRCLOAD"]
    #[inline(always)]
    pub fn srcload(&mut self) -> SrcloadW<'_, Csr3Spec> {
        SrcloadW::new(self, 14)
    }
    #[doc = "Bit 15 - desc DSTLOAD"]
    #[inline(always)]
    pub fn dstload(&mut self) -> DstloadW<'_, Csr3Spec> {
