...
impl W {
    ...
    #[doc = "Bit 3 - desc RXIDLE"]
    #[inline(always)]
    pub fn rxidle(&mut self) -> RxidleW<'_, IcrSpec> {
        RxidleW::new(self, 3)
    }
    #[doc = "Bit 4 - desc RXBRK"]
    #[inline(always)]
    pub fn rxbrk(&mut self) -> RxbrkW<'_, IcrSpec> {
        RxbrkW::new(self, 4)
    }
    #[doc = "Bit 5 - desc BAUD"]
    #[inline(always)]
    pub fn baud(&mut self) -> BaudW<'_, IcrSpec> {
        BaudW::new(self, 5)
    }
    #[doc = "Bit 6 - desc TIMOV"]
    #[inline(always)]
    pub fn timov(&mut self) -> TimovW<'_, IcrSpec> {
        TimovW::new(self, 6)
    }
    #[doc = "Bit 7 - desc CTS"]
    #[inline(always)]
    ...
    #[doc = "Bit 10 - desc NE"]
    #[inline(always)]
    pub fn ne(&mut self) -> NeW<'_, IcrSpec> {
        NeW::new(self, 10)
    }
    #[doc = "Bit 11 - desc ORE"]
    #[inline(always)]
    pub fn ore(&mut self) -> OreW<'_, IcrSpec> {
        OreW::new(self, 11)
    }
    #[doc = "Bit 12 - desc RXMATCH"]
    #[inline(always)]
    pub fn rxmatch(&mut self) -> RxmatchW<'_, IcrSpec> {
