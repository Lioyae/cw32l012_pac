...
impl W {
    #[doc = "Bits 0:3 - desc SQRCH0"]
    #[inline(always)]
    pub fn sqrch0(&mut self) -> Sqrch0W<'_, SampleSpec> {
        Sqrch0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - desc SQRCH1"]
    #[inline(always)]
    pub fn sqrch1(&mut self) -> Sqrch1W<'_, SampleSpec> {
        Sqrch1W::new(self, 4)
    }
    #[doc = "Bits 8:11 - desc SQRCH2"]
    #[inline(always)]
    pub fn sqrch2(&mut self) -> Sqrch2W<'_, SampleSpec> {
        Sqrch2W::new(self, 8)
    }
    #[doc = "Bits 12:15 - desc SQRCH3"]
    #[inline(always)]
    pub fn sqrch3(&mut self) -> Sqrch3W<'_, SampleSpec> {
        Sqrch3W::new(self, 12)
    }
    #[doc = "Bits 16:19 - desc SQRCH4"]
    #[inline(always)]
    pub fn sqrch4(&mut self) -> Sqrch4W<'_, SampleSpec> {
        Sqrch4W::new(self, 16)
    }
    #[doc = "Bits 20:23 - desc SQRCH5"]
    #[inline(always)]
    pub fn sqrch5(&mut self) -> Sqrch5W<'_, SampleSpec> {
        Sqrch5W::new(self, 20)
    }
    #[doc = "Bits 24:27 - desc SQRCH6"]
    #[inline(always)]
    pub fn sqrch6(&mut self) -> Sqrch6W<'_, SampleSpec> {
        Sqrch6W::new(self, 24)
    }
    #[doc = "Bits 28:31 - desc SQRCH7"]
    #[inline(always)]
    pub fn sqrch7(&mut self) -> Sqrch7W<'_, SampleSpec> {
        Sqrch7W::new(self, 28)
    }
}
#[doc = "desc SAMPLE\n\nYou can [`read`](crate::Reg::read) this register and get [`sample::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sample::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
impl crate::Writable for SampleSpec {
