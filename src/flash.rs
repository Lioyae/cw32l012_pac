...
impl RegisterBlock {
    ...
    #[doc = "0x70 - SDK config register"]
    #[inline(always)]
    pub const fn sdkcfr(&self) -> &Sdkcfr {
        &self.sdkcfr
    }
}
...
pub mod icr;
#[doc = "SDKCFR (r) register accessor: SDK config register\n\nYou can [`read`](crate::Reg::read) this register and get [`sdkcfr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sdkcfr`] module"]
#[doc(alias = "SDKCFR")]
pub type Sdkcfr = crate::Reg<sdkcfr::SdkcfrSpec>;
