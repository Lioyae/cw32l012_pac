...
impl W {
    ...
    #[doc = "Bits 8:10 - desc STATUS"]
    #[inline(always)]
    pub fn status(&mut self) -> StatusW<'_, CsrSpec> {
        StatusW::new(self, 8)
    }
    #[doc = "Bit 11 - desc RESTART"]
    #[inline(always)]
    pub fn restart(&mut self) -> RestartW<'_, CsrSpec> {
        RestartW::new(self, 11)
    }
    #[doc = "Bit 14 - desc SRCLOAD"]
    #[inline(always)]
    pub fn srcload(&mut self) -> SrcloadW<'_, CsrSpec> {
        SrcloadW::new(self, 14)
    }
    #[doc = "Bit 15 - desc DSTLOAD"]
    #[inline(always)]
    pub fn dstload(&mut self) -> DstloadW<'_, CsrSpec> {
